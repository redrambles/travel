	...
	var MobileMenu = function () {
	  ...
	  _createClass(MobileMenu, [{
	    ...
	    value: function toggleTheMenu() {
	      ...
	      this.siteHeader.toggleClass("site-headerpadding-right: 20px;");
	...
	var RevealOnScroll = function () {
	  ...
	  _createClass(RevealOnScroll, [{
	    ...
	    value: function createWaypoints() {
	      var that = this; // so that the 'this' keyword still points to the class and not the new 'Waypoint' object created below  
